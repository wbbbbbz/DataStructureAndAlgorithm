...
public class MSTTest {
    ...
    // 测试我们实现的两种Prim算法和Kruskal算法的性能差距
    private static void testMST() {

        String filename1 = "testfiles\\testWG1.txt";
        int V1 = 8;

        String filename2 = "testfiles\\testWG2.txt";
        int V2 = 250;

        String filename3 = "testfiles\\testWG3.txt";
        int V3 = 1000;

        String filename4 = "testfiles\\testWG4.txt";
        int V4 = 10000;

        // String filename5 = "testfiles\\testWG5.txt";
        // int V5 = 1000000;
        ...
        System.out.println("Test for G1: " + (endTime - startTime) / 1000000.0 + "ms.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST2 = new LazyPrimMST<Double>(g2);
        endTime = System.nanoTime();
        System.out.println("Test for G2: " + (endTime - startTime) / 1000000.0 + "ms.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST3 = new LazyPrimMST<Double>(g3);
        endTime = System.nanoTime();
        System.out.println("Test for G3: " + (endTime - startTime) / 1000000.0 + "ms.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST4 = new LazyPrimMST<Double>(g4);
        endTime = System.nanoTime();
        System.out.println("Test for G4: " + (endTime - startTime) / 1000000.0 + "ms.");
